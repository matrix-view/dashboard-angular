...
export interface FindContactsResponse { 
    /**
     * The paginated list of contacts that applies for the provided filters
     */
    contacts?: Array<FindContact>;
    /**
     * The number of contacts that apply for the provided filters
     */
    totalCount?: number;
}
