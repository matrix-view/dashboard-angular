 ...
 */
import { BrokerCompanyCustomer } from './broker-company-customer';


export interface FindCustomerBrokerCompaniesResponse { 
    /**
     * The paginated list of customers with broker companies that applies for the provided filters
     */
    customers?: Array<BrokerCompanyCustomer>;
    /**
     * The number of customers that apply for the provided filters
     */
    totalCount?: number;
}
