 ...
 */
import { RetailCustomer } from './retail-customer';


export interface UpdateRetailCustomerResponse { 
    retailCustomer?: RetailCustomer;
    /**
     * Indicates whether the update is restricted or not
     */
    isUpdateRestricted?: boolean;
    /**
     * The ID of the ticket that was created to follow this customer update request
     */
