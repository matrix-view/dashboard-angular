 ...
 */
import { MobilityPlanAllocation } from './mobility-plan-allocation';


export interface MobilityPlanAllocationResponse { 
    mobilityPlanAllocation?: MobilityPlanAllocation;
}
