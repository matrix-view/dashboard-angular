...
export interface InputRestrictionMinMaxRange { 
    /**
     * The field name of the input restriction
     */
    field?: string;
    /**
     * The minimum value of an input restriction
     */
    minimum?: number;
    /**
     * The maximum value of an input restriction
     */
    maximum?: number;
}
